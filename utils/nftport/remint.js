      ...
      try {
        ...
        try {
          ...
          const mintInfo = {
            ...
            metadata_uri: meta_metaData.metadata_uri,
            mint_to_address: getMintAddress(meta_metaData.custom_fields.edition),
            token_id: meta_metaData.custom_fields.edition,
          };
          ...
          let mintData = await fetchWithRetry("https://api.nftport.xyz/v0/mints/customizable", options)
