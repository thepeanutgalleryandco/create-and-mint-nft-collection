const NFT_DETAILS = {
  ...
  startCollectionEditionFromNumber: '1' // Set the starting edition number of your collection. If you need to make use of Collection Contracts from NFTPort, then be sure to set this to 0. If network is set to sol, then both any value less than 2 will start the collection from 0.
};
